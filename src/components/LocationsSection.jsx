...
export default function LocationsSection({ t, sideData }) {
  ...
  const brideVenue = t.bride?.venueCard || {
    title: "Aryanagar (आर्यनगर)",
    dateTag: "16 November: Nimantran & Griha Aagaman (निमंत्रण एवं गृह आगमन)",
    bhaatLaganNote: "19 November: Bhaat & Lagan (भात एवं लगन)",
    address: "Arya Nagar, Charkhi Dadri, Distt. Charkhi Dadri, Haryana — 127306",
  };
  ...
  return (
    <section id="locations" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* 1. Groom Home Location Card (Nandha ki Dhani) */}
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-4">
              <span className="px-3.5 py-1 rounded-full bg-[var(--badge-bg)] text-[var(--badge-text)] border border-[var(--badge-border)] text-xs font-bold uppercase tracking-wider flex items-center space-x-1.5">
                ...
                <span>{t.locations?.groomTag || "Groom Home (Nandha ki Dhani)"}</span>
              </span>
        ...
        {/* 2. Bride Venue Location Card (Aryanagar) */}
        <div className="glass-wedding-card rounded-3xl p-6 sm:p-8 border border-[var(--border-gold)] shadow-xl flex flex-col justify-between relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--hero-glow)] rounded-full blur-2xl pointer-events-none" />
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-4">
              <span className="px-3.5 py-1 rounded-full bg-[var(--badge-bg)] text-[var(--badge-text)] border border-[var(--badge-border)] text-xs font-bold uppercase tracking-wider flex items-center space-x-1.5">
                <Home className="w-3.5 h-3.5" />
                <span>{t.locations?.brideTag || "Bride Venue (Aryanagar)"}</span>
              </span>
              <span className="text-xs text-[var(--accent-gold)] font-bold">{brideVenue.dateTag || "16 Nov: Griha Aagaman"}</span>
            </div>
            ...
            <div className="mt-4 p-4 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-gold)] flex items-start space-x-3 shadow-sm">
              ...
              <div className="text-xs sm:text-sm font-sans leading-relaxed">
                <p className="text-[var(--text-primary)] font-medium">
                  {brideVenue.address || "Arya Nagar, Charkhi Dadri, Distt. Charkhi Dadri, Haryana — 127306"}
                </p>
                <div className="mt-2 inline-flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-[var(--badge-bg)] border border-[var(--badge-border)] text-[var(--accent-primary)] font-bold text-[11px]">
                  <Calendar className="w-3.5 h-3.5" />
                  <span>{brideVenue.bhaatLaganNote || "19 November: Bhaat & Lagan (भात एवं लगन)"}</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1.5">
              ...
              <div className="flex flex-wrap gap-2 text-xs text-[var(--text-secondary)]">
                <span className="px-2.5 py-1 rounded-lg bg-[var(--badge-bg)] border border-[var(--badge-border)]">17 Nov: Ban & Haldi</span>
                <span className="px-2.5 py-1 rounded-lg bg-[var(--badge-bg)] border border-[var(--badge-border)]">18 Nov: Mehndi Utsav</span>
                <span className="px-2.5 py-1 rounded-lg bg-[var(--badge-bg)] border border-[var(--badge-border)]">19 Nov: Bhaat & Lagan</span>
                <span className="px-2.5 py-1 rounded-lg bg-[var(--badge-bg)] border border-[var(--badge-border)]">20 Nov: Barat Swagat & Vivah</span>
              </div>
            </div>
            ...
            <div className="mt-4 text-xs text-[var(--text-muted)] space-y-1 border-t border-[var(--border-gold)] pt-3">
              ...
              <p>• <strong>Railway:</strong> Charkhi Dadri Station (~2 KM) | Loharu (~19 KM)</p>
            </div>
          </div>
